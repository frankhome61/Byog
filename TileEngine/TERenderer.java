...
public class TERenderer {
    ...
    public void renderFrame(TETile[][] world, int score, int lev,
                            String characterMsg, int playerHealth, Hud hud) {
        int numXTiles = world.length;
        int numYTiles = world[0].length;
        StdDraw.clear(new Color(0, 0, 0));
        for (int x = 0; x < numXTiles; x += 1) {
        ...
        hud.displayHUD(numXTiles, numYTiles, score, lev, characterMsg, playerHealth, world);
        StdDraw.show();
    }
}
